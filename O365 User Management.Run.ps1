...
<#
    ...
    --------------------------------------------------------------------------------
     ...
     Generated on:       12/8/2016 7:15 AM
     Generated by:       bbone
    --------------------------------------------------------------------------------
    .DESCRIPTION
...
function Show-MainForm_psf
{
	...
	$formO365UserManagement.ClientSize = '1067, 548'
	...
	$labelConnectTo0365.Location = '67, 16'
